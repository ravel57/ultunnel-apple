...
- (void)writeConnections:(LibboxConnections* _Nullable)message;
- (void)writeGroups:(id<LibboxOutboundGroupIterator> _Nullable)message;
- (void)writeLogs:(id<LibboxStringIterator> _Nullable)messageList;
...
// skipped field OutboundGroup.ItemList with unsupported type: []*github.com/sagernet/sing-box/experimental/libbox.OutboundGroupItem
...
FOUNDATION_EXPORT const int32_t LibboxCommandCloseConnection;
FOUNDATION_EXPORT const int32_t LibboxCommandCloseConnections;
FOUNDATION_EXPORT const int32_t LibboxCommandConnections;
FOUNDATION_EXPORT const int32_t LibboxCommandGetDeprecatedNotes;
...
FOUNDATION_EXPORT LibboxStringBox* _Nullable LibboxReadServiceError(NSError* _Nullable* _Nullable error);
